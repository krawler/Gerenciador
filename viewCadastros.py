...
def sub_lista_prod_vend(pai,dados):
    cabecalhos = [u'C�digo', u'Valor Unit�rio','Quantidade','Valor Total'] #TODO pesquisar nome previamente e colocar o nome do produto aqui, ao inves do codigo
...
def tela_cad_vendas(root):
    ...
    campo3 = Label(frame_cad_vendas, text="C�digo Produto:")
...
def tela_cad_camp(root):
    ...
    campo3 = Label(frame_cad_camp, text="C�digo Produto:")
